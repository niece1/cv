  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#section5">testimonials</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#section6">contacts</a>
        </li>
      </ul>
    </div>
  </nav>
      ...
      <div class="left_advantage">
        <div class="advantage_item">
          <div class="advantage_text">
            <h6>Balance Body & Mind</h6>
            <p>dolor sit amet, consectetur adipisicing elit. Beatae quas aspernatur libero</p>
          </div>
