...
<body data-spy="scroll" data-target=".navbar" data-offset="30">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    ...
    <section id="section1"  class="parallax">
      ...
      <figcaption>
        <h2>Make your shopping more comfortable.</h2>
        ...
        <button type="button" name="button" class="btn btn-success btn-lg">Contact me</button>
      </figcaption>
      </figure>
  ...
  <div id="section2" class="container-fluid bg-warning" style="padding-top:70px;padding-bottom:70px;height:800px">
    <h1>Section 2</h1>
